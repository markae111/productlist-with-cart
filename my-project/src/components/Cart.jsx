...
export default function Cart({ onConfirm }) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm h-fit sticky top-10 font-red-hat">
      ...
      {cart.length === 0 ? (
        <div className="flex flex-col items-center py-10 text-center">
          <img src={emptyIllustration} alt="Empty Cart" />
          ...
          <div className="divide-y divide-rose-100">
            {cart.map((item) => (
              ...
              >
                ...
                >
                  <img src={iconRemove} alt="remove" className="w-2.5" />
                </button>
              </div>
            ))}
          </div>
